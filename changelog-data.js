...
window.CHUNBONG_CHANGELOG = [
  {
    ...
    items: [
      ...
      { type: 'improved', title: '최근 업데이트 PC·모바일 실제 동작 자동 점검', description: '빠른 타로, 타로 기록장, 방송 기록 캘린더, 내 팬허브, 콘텐츠 검색, 일정, 모바일 PWA 헤더 등 최근 추가 기능을 PC·모바일 브라우저에서 실제 클릭·터치 흐름으로 자동 검증하도록 회귀 테스트를 강화했습니다.' }
    ]
  },
  {
    date: '2026-09-20',

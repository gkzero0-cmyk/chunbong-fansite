window.CHUNBONG_CHANGELOG = [
  {
    ...
    items: [
      ...
      { type: 'improved', title: '춘컬타일 플레이 기능 강화', description: '일시정지와 미니게임 복귀, 전체 랭킹 등록·TOP 10, 연속 성공 콤보, 타일 제거 파티클과 경쾌한 효과음을 추가했습니다.' },
      { type: 'new', title: '미니게임 1:1 멀티플레이 베타', description: '춘트리스, 춘박게임, 춘과게임에 방 코드 기반 2인 멀티플레이를 추가했습니다.' },
      { type: 'new', title: '춘트리스 모드·난이도 확장', description: '게임 모드를 클래식 무한, 40줄 타임어택, 3분 점수전으로 개편하고 각 모드에서 노말·하드·익스트림 난이도를 선택할 수 있게 했습니다.' },
      { type: 'new', title: '춘트리스 익스트림 기믹 추가', description: '익스트림 난이도에 초고속 중력과 짧은 고정 시간, 팬텀 블록, 블링크, 바닥 가비지 라인 기믹을 순환 적용했습니다.' },
      { type: 'improved', title: '춘트리스 멀티 모드·난이도 동기화', description: '멀티플레이도 클래식·40줄·3분 점수전 × 노말·하드·익스트림 조합을 지원하며, 공유 seed로 블록 순서와 익스트림 기믹을 동일하게 맞췄습니다.' },

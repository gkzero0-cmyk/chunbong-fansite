...
window.CHUNBONG_CHANGELOG = [
  {
    date: '2026-09-23',
    items: [
      { type: 'improved', title: '오늘의 운세·춘봉 타로 크리스탈 홀로그램 인터랙션', description: '카드에 마우스를 올린 지점부터 유리·오팔처럼 프리즘 광택이 번지는 크리스탈 홀로그램 재질 효과로 개선하고, hover 효과음은 맑은 글라스 헤일로 계열로 통일했습니다. 오늘의 운세는 3초 동안 약 56회 초고속 팽이형 회전으로 카드가 거의 보이지 않다가 마지막 0.4초에 감속해 정면에서 멈추며, 맑은 풍경 한 번과 크리스탈 잔향으로 결과가 공개되도록 연출을 강화했습니다.' },

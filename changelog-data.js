...
window.CHUNBONG_CHANGELOG = [
  {
    date: '2026-09-20',
    items: [
      { type: 'new', title: '개인화 허브·타로 기록·미니게임 업적 추가', description: '오늘의 춘봉 대시보드, 즐겨찾기·나중에 보기, 최근 본 콘텐츠 이어보기, 타로 기록장, 미니게임 업적, 방송 일정 알림 설정을 한 개인화 허브로 묶었습니다.' },
      { type: 'new', title: '춘봉 타임라인 추가', description: '최근 방송 기록과 팬사이트 주요 업데이트를 날짜순으로 함께 확인할 수 있는 춘봉 타임라인 페이지를 추가했습니다.' },

...
window.CHUNBONG_CHANGELOG = [
  {
    date: '2026-09-20',
    items: [
      { type: 'new', title: '내 팬허브·개인 기록 기능 추가', description: '다시보기·핫클립·유튜브·팬아트를 보관함에 저장하고 최근 콘텐츠 이어보기, 타로 기록장, 미니게임 플레이·업적·오늘의 도전, 실행 중 방송 일정 알림, 설치형 앱 개인 홈과 춘봉 타임라인을 한곳에서 확인할 수 있도록 추가했습니다. 개인 기록은 현재 기기에만 저장됩니다.' },

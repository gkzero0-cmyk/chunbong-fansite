...
function toPublicArchiveItem(raw){
  ...
  return {...publicItem,description:publicSourceSafeText(item.description),results,participantGroups,participants,sources,timeline,media,knowledgeSections,verifiedAt:verification.verifiedAt,sourceCount:sources.length};
}

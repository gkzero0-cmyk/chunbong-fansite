...
async function analyticsOverview(days=7){
  ...
  return{
    ...
    topMenus:topRows(menus,10),menuTotal,devices:topRows(devices,20),
    topFeatures:topRows(features,14),featureTotal,hourly:topRows(hours,24).sort((a,b)=>a.key.localeCompare(b.key)),
    funnel,comparison,

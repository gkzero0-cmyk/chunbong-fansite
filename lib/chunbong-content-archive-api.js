...
const AUTO_FULL_MIGRATION_KEY='content-archive:auto-sync:full-migration:v2-placeholder-identity';
...
async function autoSyncOfficialArchive({force=false}={}){
  ...
  try{
    ...
    const changed=new Set([...applied.changedIds,...notion.changedIds]);

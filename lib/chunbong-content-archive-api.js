...
async function autoSyncOfficialArchive({force=false}={}){
  ...
  try{
    ...
    const summary={
      ...
      sourcePriority:['SOOP','YouTube'],discovered:discovery.counts,

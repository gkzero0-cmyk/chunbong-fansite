...
async function fetchNotionTree(pageId,{signal,maxPages=32,maxDepth=2}={}){
...
async function fetchNotionMeta(url,html,{signal}={}){
  ...
  return{
    ...
    outline:outline.slice(0,160),contentText:bodyText,pageCount:pages.length,strategy:'notion-record-map-recursive'
  };
}

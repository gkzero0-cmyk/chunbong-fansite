...
for (const page of pages) {
  ...
  assert.ok(html.includes(link), `${page}.html must link to the minigame hub`);
  assert.equal(html.includes('data-nav="chuntris" href="chuntris.html">춘트리스</a>'), false, `${page}.html must not expose Chuntris as the primary nav item`);
}

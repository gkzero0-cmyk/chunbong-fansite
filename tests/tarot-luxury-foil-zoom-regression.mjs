...
assert.match(css,/\.tarot-card-foil::before,[\s\S]*display:none!important/,'legacy circular ripple must be disabled');
assert.match(css,/\.tarot-card-foil\.is-foil-active::after\{opacity:\.84!important\}/,'result and zoom crystal material must remain clearly visible');

...
assert.ok(serviceWorker.includes("event.respondWith(staleWhileRevalidate(request, event));"),'scripts/styles should serve cached assets immediately while refreshing in the background');

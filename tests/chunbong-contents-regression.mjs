...
for(const asset of ['/chunbong-contents.html','/chunbong-contents.css','/chunbong-contents.js']) assert.equal(sw.includes(asset),false,asset+' should runtime-cache after first visit instead of bloating initial PWA install');

...
for(const path of workflows){
  ...
  for(const prefix of ['internal-','ci-','docs-','feat/','fix/','chore/','ci/','refactor/','test/','hotfix/']){
...
for(const key of ['data/soop-telemetry','internal-*','ci-*','docs-*','feat/*','fix/*','chore/*','ci/*','refactor/*','test/*','hotfix/*']){

...
assert.match(homeOverview, /type=schedule/, 'home overview must reuse schedule API');
assert.match(homeOverview, /type=activity/, 'home overview must reuse activity API');

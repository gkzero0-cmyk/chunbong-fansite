...
assert.match(index,/https:\/\/namu\.wiki\/w\/2020%EB%85%84/);
assert.match(index,/https:\/\/namu\.wiki\/w\/7%EC%9B%94%203%EC%9D%BC/);
assert.match(index,/https:\/\/namu\.wiki\/w\/2023%EB%85%84/);
assert.match(index,/https:\/\/namu\.wiki\/w\/11%EC%9B%94%2030%EC%9D%BC/);
...
console.log('Home D-day and NamuWiki links regression passed');

...
assert.ok(indexHtml.includes('data-kind="data"') && indexHtml.includes('<small>DATA</small>'), 'home portal should include semantic DATA card without numeric ordering');

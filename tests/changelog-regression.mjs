...
assert.ok(groups.some(group=>group.date==='2026-09-20'&&group.items.some(item=>item.title==='개인화 허브·타로 기록·미니게임 업적 추가')),'2026-09-20 personal hub entry missing');
assert.ok(groups.some(group=>group.date==='2026-09-20'&&group.items.some(item=>item.title==='춘봉 타임라인 추가')),'2026-09-20 timeline entry missing');

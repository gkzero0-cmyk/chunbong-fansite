...
for(const token of [
  'chunbak.html','minigames.html','assets/chunbak/11.png','type=chunbak-ranking','1440','390','playwright',
  ...
  'ChunbakGame.createPiece(1','ChunbakGame.showCombo(2','ChunbakGame.setGameOver()','getDebugState()','data-chunbak-action="resume"'

...
const archiveApiKnowledge=require('../lib/chunbong-content-archive-api.js');
...
const parsedNamu=archiveApiKnowledge._internals.namuWikiStructuredSections(namuSample,'https://namu.wiki/w/%EB%A0%88%EC%98%A4%ED%8E%A0');

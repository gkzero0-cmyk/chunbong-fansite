...
assert.match(page, /history\.html/, 'shared navigation must expose the broadcast history page');
assert.match(page, /방송 이력/, 'shared navigation must label the new page in Korean');

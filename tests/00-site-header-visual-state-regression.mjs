...
assert.match(shell,/setAttribute\('aria-current','page'\)/,'current nav link must expose aria-current');
assert.match(shell,/is-current-section/,'current nav group must expose a separate section state');

...
assert.ok(css.includes('https://res.cloudinary.com/lyppgyei/image/upload/c_scale,w_1120/e_sharpen:100/f_webp/q_auto:best/v1789314631/chuntris-reactions-source.webp'), 'CSS must use the enhanced 1120px reaction sprite');

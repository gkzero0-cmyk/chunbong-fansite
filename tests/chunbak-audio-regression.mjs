...
assert.ok(html.includes('id="chunbak-sound"'), 'Chunbak toolbar needs a sound toggle');
assert.ok(html.includes('id="chunbak-volume"'), 'Chunbak toolbar needs a volume range');
...
for (const cue of ['start', 'drop', 'merge', 'highmerge', 'gameover']) {

(() => {
  ...
  const STAGE_IMAGES = Object.freeze([
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168611/chunbong-fansite/minigames/chunbak/stage-1.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168618/chunbong-fansite/minigames/chunbak/stage-2.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168623/chunbong-fansite/minigames/chunbak/stage-3.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168629/chunbong-fansite/minigames/chunbak/stage-4.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168635/chunbong-fansite/minigames/chunbak/stage-5.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168641/chunbong-fansite/minigames/chunbak/stage-6.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168647/chunbong-fansite/minigames/chunbak/stage-7.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168652/chunbong-fansite/minigames/chunbak/stage-8.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168660/chunbong-fansite/minigames/chunbak/stage-9.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168665/chunbong-fansite/minigames/chunbak/stage-10.webp",
    "https://res.cloudinary.com/lyppgyei/image/upload/f_auto,q_auto:good,c_limit,w_320/v1790168671/chunbong-fansite/minigames/chunbak/stage-11.webp"
  ]);
  const STAGES = Object.freeze(Array.from({length:MAX_STAGE}, (_, index) => {
    const id = index + 1;
    return Object.freeze({ id, radius:RADII[id], image:STAGE_IMAGES[index] });
  }));
